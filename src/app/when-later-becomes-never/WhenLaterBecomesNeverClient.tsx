...
export default function WhenLaterBecomesNeverClient({ initialSlug }: { initialSlug?: string } = {}) {
  const tracks = whenLaterBecomesNeverAlbum.tracks as WLBNTrack[];
  ...
  const [index, setIndex] = useState(() => {
    ...
    return 4; // "When Later Becomes Never" title track, feels like a natural default
  });
      ...
      <main className="pt-[60px] min-h-screen font-sans" style={{ background: "#0d1117" }}>
        ...
        <section className="relative w-full overflow-hidden" style={{ minHeight: "86vh" }}>
          ...
          <div className="relative z-10 flex flex-col items-center justify-end text-center h-full px-6 pb-14" style={{ minHeight: "86vh" }}>
            ...
            >
              Album · Progressive House / House · 2026
            </span>
            <h1
            ...
            <div className="grid grid-cols-1 md:grid-cols-[168px_1fr_168px] gap-8 md:gap-10 items-start">
              ...
              <div className="order-1 md:order-2 text-center" key={enterKey}>
                ...
                {track.lyrics.length > 0 ? (
                  ...
                  <p
                    className="text-sm font-serif italic max-w-[460px] mx-auto leading-relaxed"
