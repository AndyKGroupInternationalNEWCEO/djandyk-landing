  ...
  tracks: [
    {
      ...
      videoUrl: "/videos/euphoria-needs-no-story-hero.mp4",
      audioSrc: "/audio/euphoria-intro.mp3",
      vocal: "Spoken",
      lyrics: [
        ["[Spoken Intro]", "This is DJ Andy'K."],
        ["Euphoria Needs No Story", "is the defining album of DJ Andy'K."],
        ["It replaces the withdrawn album", "Music Is Your Passion,", "which no longer represented", "the artistic direction", "and the quality standard", "of DJ Andy'K."],
